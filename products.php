...
?>
            ...
            <div class="content-push">
                ...
                <div class="information-blocks">
                    <div class="row">
                        <div class="col-sm-5 col-md-offset-1 col-md-4 col-lg-5 hidden-xs information-entry">
                            <div class="product-preview-box" style="max-height:400px;">
                                <div class="swiper-container product-preview-swiper" data-autoplay="0" data-loop="1" data-speed="500" data-center="0" data-slides-per-view="1">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="product-zoom-image">
                                                <img src="<?php echo $pic; ?>" alt="" data-zoom="<?php echo $pic; ?>" />
                                            </div>
                                        </div>
                                     </div>
                                    ...
                                    <div class="product-zoom-container">
                                        <div class="move-box">
                                            <img class="default-image" src="<?php echo $pic; ?>" alt="" />
                                            <img class="zoomed-image" src="<?php echo $pic; ?>" alt="" />
                                        </div>
                        ...
                        <div class="col-sm-5 col-md-offset-1 col-md-4 col-lg-5 visible-xs information-entry">
                            <div class="product-preview-box" style="max-height:400px;">
                                <div class="swiper-container product-preview-swiper" data-autoplay="0" data-loop="1" data-speed="500" data-center="0" data-slides-per-view="1">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                        ...
                        <div class="col-sm-7 col-md-6 information-entry">
                            <div class="product-detail-box">
                                <h1 class="product-title"><?php echo $i_name; ?></h1>
                                <h3 class="product-subtitle"><?php echo $cat; ?></h3>
                                <div class="product-description detail-info-entry"><?php echo $idesc; ?></div>
                                <div class="price detail-info-entry">
                                    <div class="current">Rs <?php echo $price; ?> per item</div>
                                </div>
